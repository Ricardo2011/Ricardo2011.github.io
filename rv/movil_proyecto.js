...
cubo3=new THREE.Mesh(new THREE.BoxGeometry(50,0.5,3),new  THREE.MeshBasicMaterial({color:'#ffff00'}));
cubo4=new THREE.Mesh(new THREE.BoxGeometry(50,0.5,3),new  THREE.MeshBasicMaterial({color:'#ffff00'}));
